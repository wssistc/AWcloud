    ...
    //快照回滚必须在云主机关机状态下
      describe('云主机快照回滚', function() {
        ...
        beforeEach(function() {
		  ...
		  moreAction.click();
		  let snapsClick  = element(by.buttonText('云主机快照回滚'));
		  snapsClick.click();
		  //选择系统盘下拉列表第一个
		  let systemDisk=element(by.model('newObj.systemDiskSnap'));
	 	  systemDisk.click()
	 	  ...
	 	  let sureClick=element(by.css('[ng-click="snapshotRollbackFunc(insForm)"]')); 
	 	  sureClick.click()
