import {PiePanelDefault,AreaPanelDefault} from "../commonFun/chartpanel";

let chartsModule = angular.module("chartsModule", []);
        ...
        link:function(scope,elem,attr){
            ...
            scope.$watch(function(){
                ...
                if(bardata){
                    if(attr.type == "basic"){
                        $timeout(function(){
                            scope.used = (Number(String(scope.bardata.data).split("%")[0])/100).toFixed(1) || 0;
                            scope.inUsepercent = (Number(String(scope.bardata.data).split("%")[0])).toFixed(1) || 0;
                        },10);
                    }else{
                        $timeout(function(){
...
export default chartsModule.name;