(function (context) {
  ...
  TheGraph.findMinMax = function (graph, nodes) {
    ...
    if (outports) {
      //console.log('>>>>>>>>', outports, graph, nodes);
  ...
  TheGraph.arcs = {
    ...
    inport: makeArcPath(0, 1/2, 4),
    outport: makeArcPath(1/2, 0, 4),
    // inportBig: makeArcPath(-1/4, 1/4, 6),
    // outportBig: makeArcPath(1/4, -1/4, 6),
    inportBig: makeArcPath(0, 1/2, 6),
    outportBig: makeArcPath(1/2, 0, 6)
  };
