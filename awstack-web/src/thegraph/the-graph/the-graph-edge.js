  ...
  TheGraph.Edge = React.createFactory( React.createClass({
    ...
    render: function () {
      ...
      if (targetY-5 < sourceY) {
        ...
        if (Math.abs(targetX-sourceX) < TheGraph.config.nodeSize/2) {
          // Loopback
          ...
          c1X = sourceX + (targetX > sourceX ? curveFactor : -curveFactor);
          c1Y = sourceY + curveFactor;
          c2X = targetX - (targetX > sourceX ? -curveFactor : curveFactor);
          c2Y = targetY - curveFactor;
        }
      } else {
      ...
      var containerOptions = {
        ...
        title:this.props.edge.from.node+":"+this.props.edge.from.port+"->"+this.props.edge.to.node+":"+this.props.edge.to.port
      };
