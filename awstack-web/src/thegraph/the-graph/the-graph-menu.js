(function (context) {
  ...
  function createMenuSlice(options) {
    ...
    //只有type为“vm”的图标才有右键功能
    if(this.props.icon=="vm" || this.props.options.type=="group"){
  ...
  TheGraph.Menu = React.createFactory( React.createClass({
    ...
    getInitialState: function() {
      ...
      return {
        ...
        s4tappable: (this.props.menu.s4 && this.props.menu.s4.action && this.props.options.item.metadata.vm_status=="active"),
        e4tappable: (this.props.menu.e4 && this.props.menu.e4.action && this.props.options.item.metadata.vm_status=="stopped"),
        w4tappable: (this.props.menu.w4 && this.props.menu.w4.action && this.props.options.item.metadata.vm_status=="active"),
      };
    },
    onTapN4: function () {
